...
В файлах `.js` добавлены комментарии на русском: что делает каждая функция и блок логики.  
Стили — оглавление в начале `css/style.css`. HTML — комментарии у крупных секций.
